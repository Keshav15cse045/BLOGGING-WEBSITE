...
<script runat="server">
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
          ...
          {
              con.Open();
               SqlCommand cmd = new SqlCommand("select uid, password from users where email = @email and password = @password", con);
                 cmd.Parameters.Add("@email", SqlDbType.NVarChar,15).Value = txtEmail.Text;
              cmd.Parameters.Add("@password", SqlDbType.NVarChar, 15).Value = txtPwd.Text;
            ...
            <tr>
                <td width="70%" valign="top">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="bid,uid"
                        DataSourceID="SqlDataSource1" Width="100%" EnableModelValidation="True">
                        <Columns>
...
where  b.bid = u.uid order by bid desc">
                    </asp:SqlDataSource>
